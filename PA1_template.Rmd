...
# Reproducible Research::Week 2 Asssignment 1
...
## Imputing missing values in given data
...
bydefault. However, after replacing missing `steps` values with the mean `steps`
